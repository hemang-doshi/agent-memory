...
Candidate proposals require evidence and reject obvious secrets. Approval promotes a candidate to active memory:
...
| Candidate | Stored for review; not injected until approved. |
